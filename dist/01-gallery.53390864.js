...
const galleryItem = (0, _galleryItemsJs.galleryItems).map((galleryItem1)=>`
<a class="gallery__item" href="${galleryItem1.original}">
  <img class="gallery__image" src="${galleryItem1.preview}" 
  alt="${galleryItem1.description}" title = "${galleryItem1.description}"/>
</a>`).join("");
